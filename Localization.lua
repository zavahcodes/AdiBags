...
L["Border with Glow (original)"] = true
L["Border without Glow (solid)"] = true
L["Choose how item quality is displayed:\n\nBorder with Glow: Traditional colored border with bright glow effect\nBorder without Glow: Colored border with solid appearance, no glow"] = true
L["Enabled"] = true
...
if locale == 'frFR' then
    ...
    L["Enter the name of your custom section"] = "Entrez le nom de la section à associer à l'objet."
...
elseif locale == 'deDE' then
    ...
    L["Enter the name of your custom section"] = "Gib den Namen des Bereiches ein, der dem Gegenstand zugewiesen werden soll"
...
elseif locale == 'esES' then
    ...
    L["Enter the name of your custom section"] = "Escribe un nombre de sección para asociar con este objeto."
...
elseif locale == 'zhTW' then
    ...
    L["Enter the name of your custom section"] = "輸入區塊名稱以建立相關"
    L["Equipment"] = "裝備"
...
elseif locale == 'zhCN' then
    ...
    L["Enter a text to search in item names."] = "输入文本搜索物品."
    ...
    L["Enter the name of your custom section"] = "输入分组名称以建立过滤"
    L["Equipment"] = "装备"
    ...
    L["Select how the bag are positionned."] = "背包定位方式"
    ...
    L["Tidy bags"] = "整理背包"
    L["Tidy your bags by clicking on the small \"T\" button at the top left of bags. Special bags with free slots will be filled with matching items and stackable items will be stacked to save space."] = "点击背包右上的小\"T\"整理背包.\\n物品将优先放入可容纳它的特殊背包, 并且可堆叠的物品将自动堆叠以便释放背包空间."
...
elseif locale == 'koKR' then
    ...
    L["Enter the name of your custom section"] = "아이템과 연계하기 위한 항목의 이름을 입력합니다."
    L["Equipment"] = "착용 장비"
    ...
    L["Tidy bags"] = "가방 정리"
    L["Tidy your bags by clicking on the small \"T\" button at the top left of bags. Special bags with free slots will be filled with matching items and stackable items will be stacked to save space."] = "가방 상단 우측에 작은 \"T\" 버튼을 클릭함으로써 가방을 정리합니다. 빈 칸의 전문 가방은 합당한 아이템으로 채워질 것이며 칸을 절약하기 위해 중첩이 가능한 아이템은 겹쳐질 것입니다."
...
elseif locale == 'ptBR' then
    ...
    L["Background colors"] = "Cor de fundo"
    L["Backpack"] = "Mochila"
    L["Bag #%d"] = "Bolsa #%d"
    ...
    L["By category, subcategory, quality and item level (default)"] = "Por categoria, subcategoria, qualidade e level do item (padrão)"
    L["By name"] = "Por nome"
    L["By quality and item level"] = "Por qualidade e level do item"
    L["Category"] = "Categoria"
    ...
    L["Enabled"] = "Ligado"
    L["ENCHANTING_BAG_TAG"] = "BOLSAS_ENCANTAMENTO"
    L["ENGINEERING_BAG_TAG"] = "BOLSAS_ENGENHARIA"
    L["Enter a text to search in item names."] = "Entre com um texto para pesquisar os nomes dos itens"
    ...
    L["Enter the name of your custom section"] = "Entre o nome da seção para associar com o item"
    ...
    L["MINING_BAG_TAG"] = "BOLSAS_MINERAÇÃO"
    L["Money"] = "Dinheiro"
    L["Never"] = "Nunca"
    L["New"] = "Novo"
    ...
    L["Select how the bag are positionned."] = "Selecione como a bolsa é posicionada"
    ...
    L["Tidy your bags by clicking on the small \"T\" button at the top left of bags. Special bags with free slots will be filled with matching items and stackable items will be stacked to save space."] = "Arrume suas bolsas clicando no pequeno botão \"T\" no topo esquerdo de suas bolsas. Bolsas especiais com espaços livres serão preenchidas com respectivos itens e itens empilháveis serão empilhados para liberar espaço"
    ...
    L["When trading:"] = "Quando negociando:"
end
